...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  void _onScroll() {
    // Puedes añadir lógica aquí si necesitas hacer algo cuando la página se desplaza
  }
      ...
      body: PageView(
        ...
        children: <Widget>[
          makePage(
            ...
            title: 'Articulos de mascotas',
            description: 'Pupi Pet: todo lo que tu mascota necesita, en un solo lugar. 🐾'
          ),
          makePage(
            page: 2,
            image: 'assets/images/dos.jpg',
            title: 'Alimentos',
            description: 'Alimento: Nutrición completa y deliciosa para tu mascota. 🦴🐾'
          ),
          makePage(
            page: 3,
            image: 'assets/images/tres.jpg',
            title: 'Muebles',
            description: "Muebles: Comodidad y estilo para el descanso de tu mascota. 🛏️🐾"
          ),
          makePage(
            page: 4,
            image: 'assets/images/cuatro.jpg',
            title: 'Juguetes',
            description: "Juguetes: Diversión garantizada para tu mascota todos los días. 🎾🐶"
          ),
        ],
      ),
    );
